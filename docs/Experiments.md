...
This file is the canonical high-level story for the repo.
...
- [run.py](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp01_iq_vs_fft/run.py)

Artifacts:

- [modulation_time_features.h5](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp01_iq_vs_fft/artifacts/modulation_time_features.h5)
- [waveform_frequency_features.h5](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp01_iq_vs_fft/artifacts/waveform_frequency_features.h5)
- [experiment1_results.json](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp01_iq_vs_fft/artifacts/experiment1_results.json)
...
- [run.py](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp02_gated_multimodal/run.py)

Artifact:

- [experiment3_results.json](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp02_gated_multimodal/artifacts/experiment3_results.json)
...
So the story does not end at multimodal fusion alone.
...
- [run.py](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp03_frozen_expert_residual/run.py)

Main artifact:

- [experiment11_frozen_expert_residual_multidataset_results.json](/home/klukasdh/Projects/DLSignalClassifier/experiments/exp03_frozen_expert_residual/artifacts/experiment11_frozen_expert_residual_multidataset_results.json)

Detailed write-up:

- [Experiment11_Frozen_Expert_Residual_Multidataset_Log.md](/home/klukasdh/Projects/DLSignalClassifier/docs/Experiment11_Frozen_Expert_Residual_Multidataset_Log.md)
...
- this is the architecture that resolves the main narrative tension in the repo
...
- [Experiments.md](/home/klukasdh/Projects/DLSignalClassifier/docs/Experiments.md)
- [Experiment5_Comparable_Experiments.md](/home/klukasdh/Projects/DLSignalClassifier/docs/Experiment5_Comparable_Experiments.md)
- [Experiment11_Frozen_Expert_Residual_Multidataset_Log.md](/home/klukasdh/Projects/DLSignalClassifier/docs/Experiment11_Frozen_Expert_Residual_Multidataset_Log.md)

## Interesting Appendix

This is not part of the core story, but it sharpens the interpretation of Experiment 3:

- [Experiment11_Correct_Set_Overlap_Log.md](/home/klukasdh/Projects/DLSignalClassifier/docs/Experiment11_Correct_Set_Overlap_Log.md)
