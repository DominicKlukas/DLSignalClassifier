...
from experiments.shared.repro import classification_metrics, configure_device, make_tensor_loader, save_json, set_global_seed
from experiments.shared.story_models import RepresentationCNN


ARTIFACTS_DIR = Path(__file__).resolve().parent / "artifacts"
ARTIFACTS_DIR.mkdir(parents=True, exist_ok=True)

MODULATION_DATASET_PATH = ARTIFACTS_DIR / "modulation_time_features.h5"
WAVEFORM_DATASET_PATH = ARTIFACTS_DIR / "waveform_frequency_features.h5"
RESULTS_PATH = ARTIFACTS_DIR / "experiment1_results.json"
...
def train_and_evaluate(
    ...
    return {
        ...
        **classification_metrics(y_test, y_pred, class_names),
    }
